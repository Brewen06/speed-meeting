                ...
                <div className="w-full space-y-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 max-w-3xl">
                            Consultez et recherchez les participants, puis activez ou inactivez leur présence en toute simplicité. Les invités inactifs ne seront pas pris en compte lors du lancement de la session.
                            Vous avez également la possibilité de modifier ou de supprimer des participants individuellement, ou encore de supprimer entièrement la liste pour une gestion optimale.
                        </p>
                    </div>
